...
<html lang="en">
  ...
  <body role="document">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a  href="#"><img src="img/new.png" alt="AlbertoLorente" border="2" align="middle" width="300px" height="50px"></a>
        </div>
    ...
    <div class="container theme-showcase" role="main">
	    ...
	    <table>
			<tr>
				<td class="intro">
					...
					<p>This page is a personal and professional blog about me where I expose my work and thoughts to the network</p>
					<p>Work in progres!</p>
				</td>
      ...
      <div id="studies" class="page-header">
	    <br/><br/><br/>
        <h1>Studies</h1>
      </div>
      ...
      <div id="workExperience" class="page-header">
	    <br/><br/><br/>
	  ...
	  <div id="recommendations" class="page-header">
	    <br/><br/><br/>
	  ...
	  <div id="personal" class="page-header">
	    <br/><br/><br/>
        <h1>Personal</h1>
      </div>
